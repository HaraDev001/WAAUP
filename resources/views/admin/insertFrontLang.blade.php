    ...
    <header>
        <div class="container-fluid container-bk">
            <div class="row">
                ...
                <div class="col-sm-9 row-col-title" style="flex: 0 0 74%;max-width: 74%;">FrontPage language Management</div>
            </div>
        </div>
    </header>
</section>
...
<script>
    ...
    function getFLangStr_type(){
        $.ajax({
            method: "POST",
            url: "/admin.getFLangStr_type",
            data:{
                iso:'en'
            },
            statusCode: {
    ...
    function getFLangStr_key(){
        $.ajax({
            method: "POST",
            url: "/admin.getFLangStr_key",
            data:{
                iso:'en'
            },
            statusCode: {
    ...
    function getFLangStr_link(){
        $.ajax({
            method: "POST",
            url: "/admin.getFLangStr_link",
            data:{
                iso:'en'
            },
            statusCode: {
    ...
    function getFLangStr_cont(){
        $.ajax({
            method: "POST",
            url: "/admin.getFLangStr_cont",
            data:{
                scont:scont,
                iso:'en'
            },
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.msg=="ok")
                    {
                        ...
                        getFLangStr_cont();
                        alert('성공삭제');
                        //window.location.href='/frontlang';
                    }
        ...
        $('#lang-search').click(function () {
            ...
            scont = $.trim(scont);
            getFLangStr_cont();
            //window.location.href='/frontlang/'+scont;
        });
