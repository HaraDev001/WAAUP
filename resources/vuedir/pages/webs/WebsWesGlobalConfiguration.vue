    ...
    <div class="content">
        ...
        <div class="page-header">
            <div class="page-title">
                <h3>{{cmususu_webs_wesglobal_configuration}}</h3>
                <span style="color:#656262">&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;
                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                        ...
                        &nbsp;&nbsp; &nbsp;&nbsp;{{cmu_webs}} &nbsp;&nbsp;&gt;&gt;&nbsp;{{cmusu_webs_wesglobal}} &nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;{{cmususu_webs_wesglobal_configuration}}
                          <a href="#" id="webs-wesglobal-configuration-fav" data-status="off" data-page-info="Configuration_webs-wesglobal-configuration">
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-2">
                <div class="page1_content_side_bar">
                    <div class="page1_content_side_bar_text page1_content_side_bar_seleted" data-target="Listbar">{{cpgtxt_link}}</div>
                </div>
            </div>

            <div class="col-md-10 page_slider_content_list active" id="Listbar"><!--slider-->
                <div class="card">
                    <div class="row">
                        <div class="col-md-12">
...
<script>
          ...
          /*  if (fidx == 0 && plen == 0)
           ...
           // c_tag += '</div>';
            ...
            if (status != null && status != "" && status == "enable")
                c_tag += '<option value="enable" selected>'+enabletxt+'</option>';
            else
                c_tag += '<option value="enable">'+enabletxt+'</option>';

            if (status != null && status != "" && status == "disable")
                c_tag += '<option value="disable" selected>'+disabletxt+'</option>';
            else
                c_tag += '<option value="disable">'+disabletxt+'</option>';

            if (status != null && status != "" && status == "delete")
                c_tag += '<option value="delete" selected>'+deletetxt+'</option>';
            else
                c_tag += '<option value="delete">'+deletetxt+'</option>';
    ...
    export default {
        name: "WebsWesGlobalConfiguration",
       /* components: {
            CKEditor
        },*/
        data(){
            return {
                pageid:'webs-wesglobal-configuration-fav',
                mu_webs:'',
                musu_webs_wesglobal:'',
